    ...
    <div class="nav-navicon admin-main admin-sidebar">
        ...
        <div class="sideMenu">
            ...
            <ul>
                ...
                <li class="func"><a href="ProductServlet?methods=increasedPage">添加新商品</a></li>
                <li>商品分类</li>
                <li>用户评论</li>
                <li>商品回收站</li>
                <li>库存管理</li>
            ...
            <div class="fbneirong">
                ...
                <form class="am-form" action="product/productAction!upload" method="post" name="addproduct"
                    ...
                    <div class="am-form-group am-cf">
                        ...
                        <div class="you">
                            <input type="text" class="am-input-sm" name="product.pname" placeholder="请输入商品名称">
                        </div>
                    </div>
                    <div class="am-form-group am-cf">
                        <div class="zuo">单价：</div>
                        <div class="you">
                            <input type="text" class="am-input-sm" name="product.price" placeholder="请输入商品价格">
                        </div>
                    </div>
                    <div class="am-form-group am-cf">
                        <div class="zuo">数量：</div>
                        <div class="you">
                            <input type="text" class="am-input-sm" name="product.mount" placeholder="请输入商品数量">
                        </div>
                    </div>
                    <div class="am-form-group am-cf">
