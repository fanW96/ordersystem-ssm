...
<div class="nav-navicon admin-main admin-sidebar">
    ...
    <div class="sideMenu am-icon-dashboard" style="color:#aeb2b7; margin: 10px 0 0 0;"> 欢迎<s:property value="#session.loginUser.username"/>：<s:property value="#session.loginUser.limit.description"/><a href="LoginAndRegisterServlet?methods=loginOut">安全退出</a></div>
    <div class="sideMenu">
...
<div class=" admin-content">
		...
		<div class="daohang">
			<ul>
              <li><button type="button" onclick="javascript:location.href='index.jsp'" class="am-btn am-btn-default am-radius am-btn-xs">首页</button> </li>
